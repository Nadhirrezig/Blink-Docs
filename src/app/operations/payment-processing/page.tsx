...
import { DollarSign, Shield, HandCoins, Lock } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-red-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Our system accurately tracks all cash transactions and calculates change automatically to ensure precise cash handling.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-red-200 dark:border-gray-700">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Always count your cash before and after the transaction to ensure accuracy.
              </p>
            </div>
          </div>
        </div>
